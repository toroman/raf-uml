...
public class DiagramPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    /**
     * Da li da se panel refreshuje kada se kursor kretje (drag ili move). Ochekivan performance
     * hit, meni se ni ne ostetja ali tje verovatno Sretjku dodatno usporiti. Staviti na true samo
     * kada je nepohodno!
     * 
    ...
    public Dimension getPreferredSize() {
        return new Dimension((int)(diagram.getMaxWidth() * zoomLevel), (int)(diagram.getMaxHeight() * zoomLevel));
    }

    /**
     * Ovi listeneri transformisu kordinate iz View-a u "UML" koordinate (time omogucavaju zoom) a
     * zatim ih proslede listeneru (currentTool)
     */
